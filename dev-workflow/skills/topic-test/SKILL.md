...
6. BEFORE Step 8: [`${CLAUDE_PLUGIN_ROOT}/skills/_shared/rules/topic-doc-writing-conventions.md`](../../_shared/rules/topic-doc-writing-conventions.md) — the per-prompt and per-session discipline reminders that must be delivered verbatim at the end of the run.
